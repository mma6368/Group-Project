      ...
      <div className="py-4">
                ...
                <div className="card-header">
                  ...
                  <div className="col-md-6">
                        <div className="form-group mb-3">
                          <label>Standard / Express Shipping</label>
                          <input
                            type="text"
                            name="shippingMethod"
        ...
        {invoice && (
          ...
          <div className="invoice">
            ...
            <p>
              <strong>Order Total:</strong> ${invoice.totalAmount * 0.06 + totalAmount}
            </p>
            ...
            <p>
              <strong>Standard / Express Shipping:</strong> {invoice.shippingmet.shippingMethod}
            </p>
